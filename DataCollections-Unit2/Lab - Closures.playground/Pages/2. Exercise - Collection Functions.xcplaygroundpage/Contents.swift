 ...
 */
let forwards: (String, String) -> Bool = { name1, name2 in
    return name1 == name2
}

let response = forwards("Alex", "Andrea")
print(response)
...
let sortedCollection1: [String] = ["Alessandro", "Andrea", "Pietro"].sorted(by: forwards)
...
let sortedCollection2: [String] = ["Alessandro", "Andrea", "Pietro"].sorted { (name1, name2) -> Bool in
    return name1 == name2
}
...
let sortedCollection3: [String] = ["Alessandro", "Andrea", "Pietro"].sorted(by: { $0 == $1 })
