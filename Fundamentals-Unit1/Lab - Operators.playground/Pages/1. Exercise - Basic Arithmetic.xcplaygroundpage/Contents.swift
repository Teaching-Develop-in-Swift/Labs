...
print("They differ as the first division uses integers and the latter uses floats.")
/*:
...
let cicumference = 2 * pi * diameter
...
print(odd % 2)
print(even % 2)
print(odd % 2 == 0 ? "Even" : "Odd")
print(even % 2 == 0 ? "Even" : "Odd")
/*:
