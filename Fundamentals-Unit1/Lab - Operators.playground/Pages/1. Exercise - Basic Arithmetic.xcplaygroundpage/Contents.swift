...
/// Division between two double, is a double. A division between two integer is an integer.
/*:
...
print(even % 2)
print(odd % 2)
/// A number is even if the remainder of dividing the value by 2, is 0, otherwise the numbers is odd.
/*:
