...
struct User {
    ...
    static var currentUser = User(userName: "samuelerizzo", email: "samuelerizzo.sr@icloud.com", age: 24)
 ...
 */
User.logIn(user: User(userName: "timcook", email: "tim.cook@icloud.com", age: 61))
/*:
