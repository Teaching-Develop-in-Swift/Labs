...
/// This doesn't work because weapon is a propery of Fighter class, which inherit from the Spaceship class. The Spaceship properties do not change, so we will not have a weapon property in an object of type Spaceship.
