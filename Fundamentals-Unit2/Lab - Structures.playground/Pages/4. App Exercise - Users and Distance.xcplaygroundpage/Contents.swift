...
var riccardo = User(name: "Riccardo", age: 27, height: 187, weight: 80, activityLevel: 5)
print("Name: \(riccardo.name)\nAge: \(riccardo.age)\nHeight: \(riccardo.height)\nWeight: \(riccardo.weight)\nActivityLevel: \(riccardo.activityLevel)")
/*:
...
let anotherDistance = Distance(meters: 400)
print("Distance in meters: \(anotherDistance.meters)\nDistance in feet: \(anotherDistance.feet)")
/*:
