...
var apiUser = User(name: "Apiphoom", age: 18, height: 188, weight: 74, activityLevel: 9)
print("My name is \(apiUser.name). I am \(apiUser.age) years old, weigh \(apiUser.weight) kilograms and stand \(apiUser.height) centimeters tall. On a scale of 1-10, I would rate my activity level as \(apiUser.activityLevel).")
...
let myDistance = Distance(meters: 5000)
print(myDistance.feet)
/*:
