 ...
 */
var walkingChallenges: [String] = ["Walk 3 miles a day", "Walk with your pet for 2 miles"]
var runningChallenges: [String] = ["Run 5 days a week", "Run 42 miles in a month"]
...
if yourChallenges.isEmpty {
    print("Go back to checking out the challenges!")
} else if yourChallenges.count == 1 {
    print("The challenge you have chosen is \(yourChallenges[0])")
} else {
