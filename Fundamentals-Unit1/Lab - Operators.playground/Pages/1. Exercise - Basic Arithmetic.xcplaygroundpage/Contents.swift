...
print("The area of the shed is: \(area)")
...
print("The perimeter of the shed is: \(perimeter)")
...
print("Expected result of integer division of 10 divided by 3: 3")
let integerDivisionResult = 10 / 3
print("The result of integer division of 10 divided by 3 is: \(integerDivisionResult)")
...
print("The result of division with Double type is: \(divisionResult)")
...
print("The remainder of 12 divided by 5 is: \(integerConstant)")
...
print("The remainder of dividing even integer by 2 is: \(evenRemainder)")
let oddRemainder = odd % 2
print("The remainder of dividing odd integer by 2 is: \(oddRemainder)")
