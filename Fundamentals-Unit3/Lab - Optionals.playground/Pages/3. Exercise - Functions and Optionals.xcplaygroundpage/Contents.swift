...
func checkAge(param: String) -> Int?{
    if let param = Int(param){
        param >= 18 ? print("Welcome") : print("Sorry, but you aren't old enough to use our app.")
        return param
    }
    else{
...
checkAge(param: userInputAge)

//:  Go back and update your function to return the age as an integer. Will your function always return a value? Make sure your return type accurately reflects this. Call the function and print the return value.
print(checkAge(param: userInputAge))
print(checkAge(param: "20"))
...
func price(key: String) -> Double? {
    if let itemStock = stock[key] {
        if itemStock > 0 {
            return prices[key]
        }
        return nil
...
print(price(key: "Apple")!)
print(price(key: "Broccoli")!)
/*:
