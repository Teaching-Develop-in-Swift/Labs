...
var height = Height(heightInCentimeters: 187)
print("Height before: \(height.heightInCentimeters) centimeters, \(height.heightInInches) inches")
height.heightInCentimeters = 188
print("Height after: \(height.heightInCentimeters) centimeters, \(height.heightInInches) inches")
/*:
