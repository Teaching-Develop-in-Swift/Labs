...
let double3: Double = 10
let divisionResult = double10 / double3
print(divisionResult)
print("The value is not rounded")
/*:
...
let intExample: Int = 12
let r = intExample.remainderReportingOverflow(dividingBy: 5)
print(r)
...
let even: Int = 2
let odd: Int = 3
print(even.remainderReportingOverflow(dividingBy: 2))
print(odd.remainderReportingOverflow(dividingBy: 2))
print("If partialValue is 0, the number is even")
/*:
