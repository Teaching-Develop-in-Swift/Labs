...
print("1- Falcon is defined in this scope")
print("2- If Falcon is defined in this scope, falcon does not have weapon property, because falcon is instance of Spaceship and Spaceship class does not have weapon property")
