...
//print("The value of foo is \(foo)")
/// The code above generates a compiler error because the scope of the foo constant is the for loop
...
/// The code above compiles because x is declared outside the for loop
...
greeting(greeting: "Good afternoon", name: "Sara")
