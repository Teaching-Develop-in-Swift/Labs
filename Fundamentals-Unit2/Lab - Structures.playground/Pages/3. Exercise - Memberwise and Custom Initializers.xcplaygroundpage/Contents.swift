...
let favoriteBook = Book(title: "Develop in Swift Fundamentals", author: "Apple Education", price: 0)
...
var myHeight = Height(heightInCentimeters: 187)
print("Height in inches: \(myHeight.heightInInches)\nHeight in centimeter: \(myHeight.heightInCentimeters)")
/*:
