...
print("The keyword 'let' creates an immutable constant, its initial value cannot be changed. If we want to fix this we would need to create a mutable variable using the keyword 'var'. ")
