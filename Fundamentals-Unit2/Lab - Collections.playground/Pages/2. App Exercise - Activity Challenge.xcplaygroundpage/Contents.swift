 ...
 */
var walkingChallenges: [String] = ["Walk for 20 minutes", "Walk 10000 passi for day"]
var runningChallenges: [String] = ["Run for 20 minutes", "Run 10000 passi for day"]
...
if !committedChallenges.isEmpty {
    print("Please commit your challenges")
