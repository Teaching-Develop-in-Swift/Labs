...
var thiti = User(name: "thiti", age: 42, height: 179, weight: 85, activityLevel: 6)
print("My name is \(thiti.name). I am \(thiti.age), weigh \(thiti.weight) kg and am \(thiti.height) cm. On an activity scale from 1-10 I am probably a \(thiti.activityLevel).")
