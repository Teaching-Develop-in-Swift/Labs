...
func pacing(currentDistance: Double, totalDistance: Double, currentTime: Double, goalTime: Double) {
    ...
    // Pace is a measure of the speed at which you run, To calculate your pace, you simply divide the total time it takes you to run a given distance by the distance itself. 
...
pacing(currentDistance: 50, totalDistance: 100, currentTime: 5.0, goalTime: 10.0)
