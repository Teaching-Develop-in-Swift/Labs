 ...
 */
struct User {
    static var currentUser: User = User(userName: "robocop", email: "rjt97@icloud.com", age: 23)
 ...
 */
let newUser = User(userName: "JumbalayaJoe", email: "jjisthebest@icloud.com", age: 31)
