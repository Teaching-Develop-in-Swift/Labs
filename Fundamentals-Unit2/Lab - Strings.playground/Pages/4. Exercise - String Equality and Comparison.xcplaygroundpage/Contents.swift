 ...
 */
print(nameInCaps.lowercased() == name.lowercased() ?
        "\(nameInCaps.lowercased()) and \(name.lowercased()) are the same." :
        "\(nameInCaps.lowercased()) and \(name.lowercased()) are not the same."
)
