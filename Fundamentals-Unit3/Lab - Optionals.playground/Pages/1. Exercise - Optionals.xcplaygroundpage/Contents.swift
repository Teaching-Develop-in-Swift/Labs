...
print("The Int(String:) constructor return an Int? that is different than Int userAge definition")
...
print(userAge)
print("It is nil because Int(String:) constructor return nil if the paramter is not an number")
/*:
