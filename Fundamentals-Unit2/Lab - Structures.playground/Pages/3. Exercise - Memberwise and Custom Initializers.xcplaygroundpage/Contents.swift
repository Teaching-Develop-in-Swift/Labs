...
let somePalce = GPS(latitude: 51.514004, longitude: 0.125226)
print(somePalce.longitude)
print(somePalce.latitude)
...
var favoriteBook = Book(title: "Ponniyin Selvan", author: "Kalki", pages: 3000, price: 1200.00)
print("My favorite book is \(favoriteBook.title) is authored by \(favoriteBook.author)")
