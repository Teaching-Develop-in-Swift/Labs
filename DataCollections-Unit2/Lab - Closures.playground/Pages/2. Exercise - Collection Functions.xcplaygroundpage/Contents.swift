...
let collection1 = ["asd", "amr", "sakr", "zahf"]
let sortedCollection1 = collection1.sorted(by: forwards)
...
let sortedCollection2 = collection1.sorted(by: { (name1: String, name2: String) in
    return name1 < name2
})
...
let sortedCollection3 = collection1.sorted(by: {$0<$1})
