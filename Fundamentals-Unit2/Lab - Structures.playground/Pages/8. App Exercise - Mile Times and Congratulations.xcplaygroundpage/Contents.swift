...
struct RunningWorkout {
    ...
    var avarageMileTime: Double {
        (distance / time) * 1600
    }
}
var runningWorkout = RunningWorkout(distance: 30.0, time: 22.2, elevation: 18.4)
print(runningWorkout.avarageMileTime)
