...
func checkAge(stringAge: String) -> Int? {
    guard let age = Int(stringAge) else {
...
checkAge(stringAge: "A")
checkAge(stringAge: "13")
checkAge(stringAge: "20")
//:  Go back and update your function to return the age as an integer. Will your function always return a value? Make sure your return type accurately reflects this. Call the function and print the return value.
if let age = checkAge(stringAge: "20") {
    print(age)
}
...
func getPriceFor(item: String) -> Double? {
    guard let itemCount = stock[item], itemCount > 0 else { return nil }
    guard let price = prices[item] else { return nil }
    return price
}
if let price = getPriceFor(item: "Chips") {
    print(price)
}
/*:
