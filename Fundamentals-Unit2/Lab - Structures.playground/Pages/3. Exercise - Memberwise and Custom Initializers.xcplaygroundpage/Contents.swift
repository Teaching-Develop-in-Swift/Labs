...
var favoriteBook = Book(title: "Asd", author: "Asd", pages: 4, price: 1.5)
...
print("someonesHeight.heightInCentimeters \(someonesHeight.heightInCentimeters == 165.1)")
...
var myHeight = Height(heightInCentimeters: 163)
print("\(myHeight.heightInInches == Height(heightInInches: myHeight.heightInInches).heightInInches)")
