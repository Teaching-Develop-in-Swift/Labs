...
print(String(describing: userAge))
...
/// Because the Int constructor that accept a String, is a failable constructor which returns nil if an Int cannot be obtained starting from the passed string.
/*:
