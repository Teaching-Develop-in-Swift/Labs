...
struct User {
    ...
    static var currentUser: User = User(userName: "simonwestuk", email: "simonwestuk@me.com", age: 35)
...
print("\(User.currentUser.userName) \(User.currentUser.email) \(User.currentUser.age)")
 ...
 */
let user = User(userName: "simonwestuk2", email: "simonwestuk2@me.com", age: 32)
