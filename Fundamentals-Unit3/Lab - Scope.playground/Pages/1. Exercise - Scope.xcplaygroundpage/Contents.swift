...
// x is defined outside the for in loop, is modified inside the for in loop scope. foo is defined inside the for in loop so outside that scope, foo doesn't exist.
...
greeting(greeting: "Welcome", name: "Sara")
