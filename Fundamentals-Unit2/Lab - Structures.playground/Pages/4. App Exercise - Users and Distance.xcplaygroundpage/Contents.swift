...
var simon = User(name: "Simon West", age: 35, height: 163, weight: 11, activityLevel: 2)

print("\(simon.name) is \(simon.age) and is \(simon.height)cm tall and weighs \(simon.weight)st, with an acticity level of \(simon.activityLevel).")
...
let heightinM = Distance(meters: 163)

print(heightinM.feet)
