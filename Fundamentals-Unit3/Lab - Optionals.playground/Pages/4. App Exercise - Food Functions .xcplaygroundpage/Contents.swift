...
func checkMeal(mealName: String) -> Meal? {
    if let meals = meals[mealName] {
        return meals
    } else {
        return nil
    }
...
let firstCase = checkMeal(mealName: "Breakfast")
print(firstCase)
let secondCase = checkMeal(mealName: "Luch")
print(secondCase)
let thridCase = checkMeal(mealName: "Dinner")
print(thridCase)
/*:
