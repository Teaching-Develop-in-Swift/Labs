...
//print("The value of foo is \(foo)")
//Foo is out of scope as it is local to for { }
...
//X is defined and modfied in global scope where foo is in local scope.
...
greeting(greeting: "Hi there", name: "Simon")
greeting(greeting: nil, name: "Simon")
...
let car = Car(make: "CI", model: "DS", year: 2021)
