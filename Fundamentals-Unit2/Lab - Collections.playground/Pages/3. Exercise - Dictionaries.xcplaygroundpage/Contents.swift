 ...
 */
var monthDict: [String: Int] = ["January": 31, "February": 28, "March": 31]
print(monthDict)
//:  Using subscripting syntax to add April to the collection with a value of 30. Print the dictionary.
monthDict["April"] = 30
//:  It's a leap year! Update the number of days in February to 29 using the `updateValue(_:, forKey:)` method. Print the dictionary.
monthDict.updateValue(29, forKey: "February")
print(monthDict)
//:  Use if-let syntax to retrieve the number of days under "January". If the value is there, print "January has 31 days", where 31 is the value retrieved from the dictionary.
if let januaryDays = monthDict["January"] {
...
if let colorArrayFromDict = dict["colorsArray"], let lastColor = colorArrayFromDict.last {
    print(lastColor)
}
/*:
