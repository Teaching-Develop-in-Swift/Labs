...
var rajkamal = User(name: "Rajkamal", age: 44, height: 173.0, weight: 75.5, activityLevel: 10)
print("\(rajkamal.name) is \(rajkamal.age) old with activitylevel of \(rajkamal.activityLevel)")
/*:
...
var distance = Distance(meters: 1600)
print(distance.feet)
...
var anotherDistance = Distance(feet: 2000)
mile = anotherDistance
print(mile.feet)
print(mile.meters)
/*:
